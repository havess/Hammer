...
class Point2D {
 ...
 public:
  ...
  friend std::vector<Point2D> &operator<<(std::vector<Point2D> &v,
                                          const Point2D &p);
  ...
  static bool isLeftTurn(const Point2D &p1, const Point2D &p2,
                         const Point2D &p3);
  static bool isRightTurn(const Point2D &p1, const Point2D &p2,
                          const Point2D &p3);
